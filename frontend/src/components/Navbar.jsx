...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed left-0 right-0 top-0 z-50  dark:bg-slate-900 dark:text-white 
         ${
           colorChange
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">Bstore</a>
          </div>
